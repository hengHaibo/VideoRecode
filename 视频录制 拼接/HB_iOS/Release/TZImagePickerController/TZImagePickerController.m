...
//    self.cannotSelectLayerColor = [[UIColor whiteColor] colorWithAlphaComponent:0.8];
    ...
    self.iconThemeColor = [UIColor colorWithRed:255/255.0f green:78/255.0f blue:104/255.0f alpha:1.0f];
...
- (void)setTakePictureImageName:(NSString *)takePictureImageName {
    ...
    _takePictureImage = [UIImage imageNamed:takePictureImageName];
}
//选中图片
...
//    _photoDefImage = [UIImage tz_imageNamedFromMyBundle:photoDefImageName];
    _photoDefImage = [UIImage imageNamed:@"Oval normal"];
}
...
//    self.navigationItem.rightBarButtonItem = cancelItem;
  ...
  if (@available(iOS 13.0, *)) {
    ...
    UIBarButtonItem *nextItem = [[UIBarButtonItem alloc] initWithTitle:@"下一步" style:UIBarButtonItemStylePlain target:self action:nil];
...
//    [self pushPhotoPickerVc];
    TZPhotoPickerController *photoPickerVc = [[TZPhotoPickerController alloc] init];
    photoPickerVc.columnNumber = self.columnNumber;
    TZAlbumModel *model = _albumArr[0];
    photoPickerVc.model = model;
