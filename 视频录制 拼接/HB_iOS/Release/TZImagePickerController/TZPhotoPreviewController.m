...
//  _toolBar.backgroundColor = [UIColor redColor];
  ...
  _numberButton.titleLabel.font = [UIFont systemFontOfSize:16.0f];
  [_numberButton setTitle:[NSString stringWithFormat:@"确定 (%zd)",_tzImagePickerVc.selectedModels.count] forState:UIControlStateNormal];;
  [_numberButton setTitleColor:[UIColor colorWithRed:255/255.0 green:62/255.0 blue:104/255.0f alpha:1.0f] forState:UIControlStateNormal];
  [_numberButton addTarget:self action:@selector(backButtonClick) forControlEvents:UIControlEventTouchUpInside];
...
//    [_toolBar addSubview:_numberImageView];
    [_toolBar addSubview:_numberButton];
...
//    _backButton.frame = CGRectMake(10, 10 + statusBarHeightInterval, 44, 44);
    ...
    _doneButton.frame = CGRectMake(self.view.tz_width - _doneButton.tz_width - 12, 0, 80, 44);
    _numberImageView.frame = CGRectMake(_doneButton.tz_left - 50 - 5, 10, 80, 24);
//    _numberLabel.frame = _numberImageView.frame;
     _numberButton.frame = _numberImageView.frame;
...
- (void)refreshNaviBarAndBottomBarState {
  ...
  _numberButton.hidden = (_tzImagePickerVc.selectedModels.count <= 0 || _isHideNaviBar || _isCropImage);
